...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            'Fruits' => [
                [['en' => 'Bananas',     'fr' => 'Bananes'],      ['en' => 'Common yellow banana.',      'fr' => 'Banane jaune commune.'],      $kg],
                [['en' => 'Apples',      'fr' => 'Pommes'],       ['en' => 'Red or green apple.',        'fr' => 'Pomme rouge ou verte.'],      $kg],
                [['en' => 'Oranges',     'fr' => 'Orange'],      ['en' => 'Fresh orange.',              'fr' => 'Orange fraîche.'],            $kg],
                [['en' => 'Strawberries', 'fr' => 'Fraises'],      ['en' => 'Fresh strawberries.',        'fr' => 'Fraises fraîches.'],          $kg],
                [['en' => 'Mangos',      'fr' => 'Mangues'],      ['en' => 'Tropical mango.',            'fr' => 'Mangue tropicale.'],          $kg],
            ],
            'Vegetables' => [
                [['en' => 'Tomatoes',     'fr' => 'Tomates'],      ['en' => 'Fresh tomatoes.',             'fr' => 'Tomates fraîches.'],          $kg],
                [['en' => 'Potatoes',     'fr' => 'Pommes de terre'], ['en' => 'White potato.',           'fr' => 'Pomme de terre blanche.'],     $kg],
                [['en' => 'Onions',      'fr' => 'Oignons'],      ['en' => 'Yellow onion.',               'fr' => 'Oignon jaune.'],              $kg],
                [['en' => 'Carrots',     'fr' => 'Carottes'],     ['en' => 'Fresh carrots.',              'fr' => 'Carottes fraîches.'],         $kg],
                [['en' => 'Spinach',    'fr' => 'Épinards'],     ['en' => 'Fresh spinach leaves.',       'fr' => 'Feuilles d\'épinard fraîches.'], $kg],
            ],
            'Dairy and Eggs' => [
                ...
                [['en' => 'Cheese', 'fr' => 'Fromage'],     ['en' => 'Aged cheddar cheese.',      'fr' => 'Cheddar affiné.'],            $kg],
            ...
            'Meat and Poultry' => [
                ...
                [['en' => 'Ground Beef',    'fr' => 'Viande haché'],      ['en' => 'Lean ground beef.',        'fr' => 'Bœuf haché maigre.'],         $kg],
                [['en' => 'Lamb Chops',     'fr' => 'Côtelettes d\'agneau'], ['en' => 'Fresh lamb chops.',  'fr' => 'Côtelettes d\'agneau fraîches.'], $kg],
                [['en' => 'Chicken Thighs',      'fr' => 'Cuisses de Poulet'], ['en' => 'Pork spare ribs.',         'fr' => 'Travers de porc.'],           $kg],
