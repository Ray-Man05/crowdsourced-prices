                ...
                <div class="hidden sm:flex items-center gap-0.5">
                    @php
                        $links = [
                            ...
                            ['route' => 'map',       'label' => __('Map'),       'path' => 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7'],
                        ...
                        <a href="{{ route('admin.categories') }}"
                           class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm transition-all
                                  {{ $adminActive
                                      ...
                                      : 'font-medium text-neutral-500 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/20' }}">
