<nav x-data="{ open: false }" class="bg-neutral-200 dark:bg-neutral-800 border-b border-neutral-100 dark:border-neutral-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-2">
                ...
                <button onclick="toggleTheme()"
                        class="p-2 rounded-lg text-neutral dark:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition"
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-neutral-500 dark:text-neutral-400 bg-neutral dark:bg-neutral-800 hover:text-neutral-700 dark:hover:text-neutral-300 focus:outline-none transition ease-in-out duration-150">
